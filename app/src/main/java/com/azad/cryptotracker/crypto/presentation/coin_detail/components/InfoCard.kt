package com.azad.cryptotracker.crypto.presentation.coin_detail.components
...
fun InfoCard(
    ...
    Card(
        ...
        //To animate the change change of icon
        AnimatedContent(
            targetState = icon,
        ...
        //To animate the change change of value
        AnimatedContent(
